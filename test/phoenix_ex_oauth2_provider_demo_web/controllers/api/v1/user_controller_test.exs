defmodule PhoenixExOauth2ProviderDemoWeb.API.V1.UserControllerTest do
  use PhoenixExOauth2ProviderDemoWeb.ConnCase

  alias PhoenixExOauth2ProviderDemo.Users
  alias PhoenixExOauth2ProviderDemo.Users.User
